...
import com.personalloan.module.admin.entity.AuditLog;
import com.personalloan.module.admin.repository.AuditLogRepository;
import com.personalloan.module.auth.dto.AuthResponse;
import com.personalloan.module.auth.dto.ChangePasswordRequest;
import com.personalloan.module.auth.dto.LoginRequest;
import com.personalloan.module.auth.dto.RegisterRequest;
...
public class AuthService {
    ...
    private void saveAuditLog(User user, String action, String result, String ip, String userAgent) {
        AuditLog auditLog = AuditLog.builder()
                ...
                .action(action)
                .entity("User")
                .entityId(user != null ? user.getUserId() : null)
                .ipAddress(ip)
                .userAgent(userAgent)
                .result(result)
                .build();
