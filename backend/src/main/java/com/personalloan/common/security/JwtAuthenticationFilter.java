        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                if (jwtService.isTokenValid(jwt, userDetails.getUsername())) {
                    UsernamePasswordAuthenticationToken authToken = jwtAuthenticationConverter.convert(userDetails);
            ...
            log.error("Failed to parse or validate JWT token: {}", ex.getMessage());
        }
